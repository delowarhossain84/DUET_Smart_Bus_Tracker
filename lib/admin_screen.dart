...
class _AdminScreenState extends State<AdminScreen> {
      ...
      title: Row(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: const Color(0xFF003366), borderRadius: BorderRadius.circular(4)),
            child: const Text(
              "DUET",
              style: TextStyle(color: Color(0xFF9EEFFF), fontSize: 10, fontWeight: FontWeight.bold),
            ),
          ),
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  SizedBox(width: 4),
                  Text("Main Campus & Medical", style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w600)),
        ...
        Wrap(
          ...
          children: [
            const Text(
              ...
              style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF001B3D)),
            ),
            Row(
              ...
              Wrap(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: const Text("Create New Route", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF001B3D),
                      foregroundColor: Colors.white,
                      elevation: 0,
            ...
            children: [
              const Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8),
                  Text("Dispatch & Scheduled Trips", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF001B3D))),
                ],
              ),
              Wrap(
                spacing: 8,
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              const Text("Campus Stops & Waypoints", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF001B3D))),
              const Spacer(),
              ElevatedButton.icon(
                onPressed: () {
                ...
                label: const Text("Create New Stop", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF001B3D),
                  foregroundColor: Colors.white,
                  elevation: 0,
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              const Text("Student Commute Analytics by Department", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF001B3D))),
              const Spacer(),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                decoration: BoxDecoration(color: const Color(0xFFD6E3FF), borderRadius: BorderRadius.circular(12)),
                child: Text("$totalStudents Registered Students", style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xFF004D99))),
              ),
            ],
          ),
          const SizedBox(height: 6),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(deptName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xFF001B3D))),
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              const Text("Fleet Live Map Telemetry", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF001B3D))),
              const Spacer(),
              ElevatedButton.icon(
                onPressed: () {
                  ...
                  child: Container(
                    ...
                    child: const Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 6),
                        Text("14 Shuttles Broadcasting • Live GPS Mesh RTK Sync 100%", style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                ),
  ...
  void _showCreateRouteModal(BuildContext context) {
    ...
    final routeCodeCtrl = TextEditingController();
    final frequencyCtrl = TextEditingController(text: "Every 10 mins");
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text("Route Title Name", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
            const SizedBox(height: 6),
            TextField(
              controller: routeNameCtrl,
              decoration: InputDecoration(
                hintText: "e.g. East Campus Corridor",
                filled: true,
            ...
            const SizedBox(height: 12),
            const Text("Line Code / Badge", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
            const SizedBox(height: 6),
            TextField(
              controller: routeCodeCtrl,
              decoration: InputDecoration(
                hintText: "e.g. Red Line Express",
                filled: true,
                fillColor: const Color(0xFFF2F4F8),
                border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
              ),
            ...
            const SizedBox(height: 12),
            const Text("Service Frequency", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
            const SizedBox(height: 6),
            TextField(
  ...
  void _showCreateStopModal(BuildContext context) {
    ...
    final stopZoneCtrl = TextEditingController();
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            const Text("Subtext / Location Details", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
            const SizedBox(height: 6),
            TextField(
              controller: stopZoneCtrl,
              decoration: InputDecoration(
                hintText: "e.g. Academic Zone • Bay C",
                filled: true,
                fillColor: const Color(0xFFF2F4F8),
                border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
              ),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              // For now, using DUET default lat/lng if user doesn't provide UI to pick
              setState(() => _isLoading = true);
              final success = await AuthService.createStop(
                name: stopNameCtrl.text,
                latitude: 24.0176, // Default
                longitude: 90.4196, // Default
              );
